...
export default function ReportPage() {
  ...
  const [mainCategory, setMainCategory] = useState(null);      // 'natural' | 'manmade'
  const [hazardType, setHazardType] = useState('');            // UI id (lowercase words)
  ...
  // Map UI ids → exact backend enum values
  const hazardTypeBackendMap = {
    "unusual tides": "Unusual Tides",
    "flooding": "Flooding",
    "coastal damage": "Coastal damage",           // lowercase 'd' per backend enum
  ...
  const handleSubmit = async (e) => {
    ...
    const backendCategory = mainCategory; // 'natural' | 'manmade'
