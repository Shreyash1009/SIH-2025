          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-700 placeholder-gray-500"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-12 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all text-gray-700 placeholder-gray-500"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center cursor-pointer">
                  <input 
                    ...
                    className="w-4 h-4 text-gradient-ocean border-gray-300 rounded focus:ring-blue-500 focus:ring-2"
                  />
                ...
                <button 
                  ...
                  className="text-sm text-gradient-ocean hover:text-blue-700 hover:underline transition-colors"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 px-6 py-3 gradient-ocean text-white rounded-xl font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg hover:shadow-xl"
              >
                {loading ? (
                  <>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-600">
                ...
                <button 
                  ...
                  className="font-semibold text-gradient-ocean hover:text-blue-700 hover:underline transition-colors"
                >
                  Sign up for free
                </button>
              </p>
